            ...
            messages=[
                {
                    "role": "system", 
                    "content": (
                        "You are Prep Mate, a friendly and smart grocery assistant. "
                        "When a user provides a dish and the number of people, "
                        "calculate the exact measurements/quantities needed. "
                        "Return only a comma-separated list of items with their quantities. "
